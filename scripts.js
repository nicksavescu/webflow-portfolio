...
$(document).ready(function () {
  ...
  $cards.hover(
    function () {
      ...
      gsap.to($hovered.find(".card-text-active"), {
        opacity: 1,
        duration: 0.3,
      });
      gsap.to($hovered.find(".card-text-inactive"), {
        opacity: 0,
        duration: 0.3,
      });
    ...
    function () {
      ...
      gsap.to($activeCard.find(".card-text-active"), {
        opacity: 1,
        duration: 0.3,
      });
      gsap.to($activeCard.find(".card-text-inactive"), {
        opacity: 0,
        duration: 0.3,
      });
    }
